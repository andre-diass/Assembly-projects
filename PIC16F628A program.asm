...
;
; O programa que implementa uma frequencia de 10KHz no pino RB3, isso poderá ser observado através do led
;ligado ao pino RB3, este led deve permanecer 50 microsegundos aceso
...
;LOOP PARA MANTER LED ACESO

           Delay_led:                                           ;função para acender o led

                               bsf PORTB, RB3                   ; LED = 1, liga led
                               call Delay_temp                  ; chama função que conta 50 microssegundos
                               bcf PORTB, RB3                   ; LED = 0, desliga led
                               return
;LOOP PARA CONTAR TEMPO

           Delay_temp:
                               movlw D’5‘                       ; move literal 5 para o w
                               movwf reg_1                      ; move w para o registrador reg_1
           ...
           CONTAGEM:
                               ...
                               nop
                               nop
                               decfsc reg_1                    ; decrementa registrador 1, gasta 2microseg.
